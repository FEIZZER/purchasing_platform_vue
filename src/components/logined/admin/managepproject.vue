 ...
 * @LastEditors: feizzer
 * @LastEditTime: 2021-12-18 22:16:27
 * @Description: 
-->
<template>
    <div class="main">
        ...
        <el-dialog :visible.sync="change_visible" title="修改项目信息">
            <el-form :model="change_detail">
                <el-form-item label="编号" label-width="80px" prop="">
                    <el-input v-model="change_detail"></el-input>
                </el-form-item>
                ...
                <el-form-item label="产品" label-width="80px" prop="product">
                    <el-input v-model="change_detail.product"></el-input>
                </el-form-item>
                <el-form-item label="项目描述" label-width="80px" prop="description">
    ...
    methods: {
        ...
        handleData(obj) {
            ...
            .then(res=>{
                let data = res.data
                if (data.success) {
                    obj.productType = data.data.productTypeInfos[0].typeId
                    let a = []
